...
name,age,salary = "Navya",22,30000
#usage of return
def details():
...
#print(details("Navya","warangal"))
#print(details("vishu","mysore"))
#print(details("rao","hyderabad",22)) # raises TypeError as only 2 arguments 
...
employee("Navya",20000,"admin")
employee(salary = 30000,role = "frontdesk",name = "Navya")
